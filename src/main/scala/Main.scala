...
object Main extends App {
  ...
  val performRangedAttackIfInRange = new RangeAttackManager2
  ...
  start(player1Units, player2Units, mapWeAreUsing, isPlayer1First)
    ...
    def turn(
      ...
      if (movedUnits.nonEmpty) {
        val RangedAttackedUnits = performRangedAttackIfInRange.performRangedAttackIfInRange(movedUnits, map, passiveUnits)
